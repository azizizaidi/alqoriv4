...
class  AdminStats extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        $fee = ReportClass::where('month', '03-2025')->sum('fee_student');
        $feeFormatted = 'RM' . number_format($fee, 2); // Format the allowance

        $allowance = ReportClass::where('month', '03-2025')->sum('allowance');
        ...
        return [
            ...
            Stat::make('Jumlah Elaun Bulan Mac 25',   $allowanceFormatted)
            ->extraAttributes([ 
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
            ...
            Stat::make('Baki Yuran Belum Bayar Mac 25', $overdueFormatted)
            ->extraAttributes([ 
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
