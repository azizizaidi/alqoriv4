...
class  AdminStats extends BaseWidget
{
    protected function getStats(): array
    {
        ...
        $fee = ReportClass::where('month', '10-2024')->sum('fee_student');
        $feeFormatted = 'RM' . number_format($fee, 2); // Format the allowance

        $allowance = ReportClass::where('month', '10-2024')->sum('allowance');
        ...
        return [
            Stat::make('Jumlah Yuran Bulan Oktober 24', $feeFormatted )
            ...
            Stat::make('Jumlah Elaun Bulan Oktober 24',   $allowanceFormatted)
            ->extraAttributes([ 
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
            ...
            Stat::make('Baki Yuran Belum Bayar Oktober 24', $overdueFormatted)
            ->extraAttributes([ 
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
