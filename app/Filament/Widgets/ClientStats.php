...
class ClientStats extends BaseWidget
{
    protected function getStats(): array
    {
           ...
           $fee = ReportClass::where('registrar_id',auth()->id())->where('month', '03-2025')->sum('fee_student');
        ...
        return [
            Stat::make('Jumlah Yuran Bulan April 25',  'RM4333')
            ...
            Stat::make('Baki Yuran Belum Bayar', 'RM455')
            ->extraAttributes([
                // 'wire:click' => '$emit("filterUpdate", "is_admin")',
